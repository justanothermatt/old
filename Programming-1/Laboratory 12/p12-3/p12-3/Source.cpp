...
int charcnt(const char* str, char c);
...
int main(void) {
	...
	if (compare == 1) { cout << "String 1 lexicographically comes after string 2" << endl; }
	else { cout << "String 1 lexicographically comes before string 2" << endl << endl; }
